...
let connectionString = `mongodb+srv://${process.env.MONGOUSERNAME}:${process.env.MONGOOSEPASSWORD}@mongobdtest.vsef73t.mongodb.net/Product_Store?retryWrites=true&w=majority`;
